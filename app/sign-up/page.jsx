...
import { parseErrorString } from "../..//lib/helperFunction";
...
const SignUpForm = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('https://res.cloudinary.com/dduiqwdtr/image/upload/f_auto,q_auto/v1/assets/3.png')" }}
    >
