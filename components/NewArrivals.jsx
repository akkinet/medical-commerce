...
const NewArrivals = async () => {
  const urls = [
    `${process.env.NEXT_PUBLIC_API_URL}/product/66a4b84c1734bf6be9656016?num=1&for=home`,
    `${process.env.NEXT_PUBLIC_API_URL}/product/66a4b88b1734bf6be965605a?num=1&for=home`,
    `${process.env.NEXT_PUBLIC_API_URL}/product/66a4b8781734bf6be9656049?num=1&for=home`,
  ];
  ...
  return (
    <div>
      <section className="text-black body-font">
        <div className="container px-5 py-24 lg: pb-2 mx-auto flex flex-col items-center ">
          <div className=" lg:w-3/4 sm:w-full product-title flex flex-col justify-center items-center mb-5 ">
            <h1 className="text-5xl font-bold mb-3">New Arrivals</h1>
              ...
              <div className="flex flex-wrap -m-4">
                {data?.map((d) => (
                  <div key={d._id} className="p-4 md:w-1/3 ">
                    <div className="border-2 shadow-xl shadow-teal-200/20 border-teal-200 rounded-lg overflow-hidden transition-transform duration-200 transform hover:scale-105">
                      <img
                      ...
                      <div className="p-6">
                        ...
                        <p className="leading-relaxed mb-3 text-sm">{d.descTitle}</p>
          ...
          <section className="text-gray-800 body-font  flex flex-col lg:px-16  lg:py-10  max-w-sm:py-0 ">
            <div className="upper-container lg:flex max-w-sm:flex-col-reverse ">
              <div className="container rounded-2xl lg:my-0 mx-auto max-w-sm: my-6 flex p-5 md:flex-row flex-col items-center lg:w-[55%]  bg-teal-400 hover:shadow-xl hover:shadow-teal-400/30">
              ...
              <div className="container rounded-2xl mx-auto lg:ml-10 max-w-sm: ml-0 flex p-5 md:flex-row flex-col items-center  bg-sky-300 hover:shadow-xl hover:shadow-sky-300/30  lg:w-[45%]  font-bold text-white ">
