        ...
        <div className='text-black mt-24 lg:flex lg:justify-center lg:mx-20'>
            {category.length == 0 ? (
                ...
                <div className='rightcontainer lg:h-fit lg:w-[90%] lg:p-1 lg:pt-0 grid gap-4 p-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4'>
                    {category.length > 0 ? (
                        category.map(cat => (
                            <div className='p-2 flex flex-col' key={cat._id}>
                                <Link href={`/category/${cat._id}`}>
                                    <div className='border-2 shadow-xl shadow-teal-200/20 border-teal-300 rounded-lg overflow-hidden flex flex-col items-center justify-between cursor-pointer transition-transform duration-200 transform hover:scale-105 '>
                                        ...
                                        <div className='p-4 flex-grow flex flex-col items-center justify-between bg-teal-300 w-full'>
